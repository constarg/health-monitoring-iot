/**
 * File: moving_common.h
 *
 ***********************************************************************
 * Contains MACROS and structure definitions used across the proeject.
 * Most of the defined MACROS are used to determine the movement thresholds,
 * such as when the user walks, runs, jumps, falls and stays.
 *
